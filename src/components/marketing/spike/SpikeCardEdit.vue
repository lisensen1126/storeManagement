...
<script>
  ...
  export default {
    name: 'spikeCard',
    mixins: [spikeApi, filterTools, ProductServiceMixin, validationMixin, FormateDate],
    components: {
      ServiceTab,
      EmptyPage,
      CustomInput,
    ...
    methods: {
      saveData () {
        ...
        this.$store.dispatch('showMessage', {
          ...
          isRejectable: 1,
          resolve: () => {
            this.editSpike(params)
          },
        })
      },
      async editSpike (params) {
        try {
