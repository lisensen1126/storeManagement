...
export default {
  ...
  data () {
    ...
    let root = 'http://panel.dev.chedianai.com/v1/common/ueditor'
    if (host === 'e.chedianai.com') {
      root = 'http://panel.chedianai.com/v1/common/ueditor'
    }
    if (host === 'e.test.chedianai.com') {
      root = 'http://panel.test.chedianai.com/v1/common/ueditor'
    }
    return {
      config: {
        serverUrl: root,
