...
<template lang="pug">
  .root.major-tab-container
    .level.major-tab
      ...
      .level-right
        store-portal
        el-tooltip(v-if="current_store.is_chain == 1", effect="dark", :content="current_store.enterprise.name", placement="bottom", popper-class="aaa")
          .store-type 连锁
        user-info-tab
</template>
...
import StorePortal from '@/components/generics/StorePortal'
