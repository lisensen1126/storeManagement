            ...
            tr(v-for="(item, i) in list")
              td
                .multi-content-td
                  ...
                  .content-item(v-if="item.order_type === 2")
                    span.bottom-image
              ...
              td
                ...
                .simple-td(v-if="item.order_type === 1") 商品服务订单
                .simple-td(v-if="item.order_type === 2") 养护卡订单保养
                .simple-td(v-if="item.order_type === 3") 线下买单订单
              td
